...
return RectorConfig::configure()
    ...
    ->withSkip([
        // EXT:news merges these class bodies into
        // GeorgRinger\News\Domain\Model\News{,Default} via its ClassCacheManager.
        // In the generated file every unqualified name resolves against the news
        // namespace, so Rector must not shorten the fully qualified class names.
        __DIR__ . '/../../Classes/Domain/Model/News.php',
        __DIR__ . '/../../Classes/Domain/Model/NewsDefault.php',
